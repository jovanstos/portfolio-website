    ...
    <main id="contact-page">
      <header className="contact-hero">
        ...
        <p className="contact-subtitle">
          Shoot me a message! I'll email you back from{" "}
          <a href="mailto:jovanstosic012@gmail.com" rel="noopener noreferrer">
        ...
        {status === "success" ? (
          ...
          <form className="contact-form" onSubmit={onSubmit} noValidate>
            ...
            <p className="privacy-note">
              By sending this, you agree to be contacted back via the email you
              provided.
            </p>
          </form>
        )}
